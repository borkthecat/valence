...
export function createTenantRateLimiter(config: RateLimitConfig, sink?: RateLimitEventSink): RequestHandler {
    ...
    return function tenantRateLimiter(req: AuthenticatedRequest, res: Response, next: NextFunction): void {
